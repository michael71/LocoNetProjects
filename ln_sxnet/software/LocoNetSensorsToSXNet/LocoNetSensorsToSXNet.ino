 ...
 *   850 to 1040 to SXnet 85 to 104 
...
#define LN_MULTIPLIER  10   // LN_ADDR = SX_ADDR + (iBit -1)  88,bit1 == 880
#define SENSOR_COMM
...
void setup() {
	...
	Serial.print(MIN_SX_ADDR * LN_MULTIPLIER);
	Serial.print(" to ");
	Serial.println(MAX_SX_ADDR * LN_MULTIPLIER);
...
#endif
	byte sxAddr = Address / LN_MULTIPLIER;
	byte sxBit = Address - LN_MULTIPLIER * sxAddr;  // sxBit 0 ..7
